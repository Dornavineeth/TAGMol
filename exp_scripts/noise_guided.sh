...
RESULT_PATH__CORD_1_CAT_1='experiments/noise_guide_v2/baseline_cord_1_cat_1'

CONFIG_FILE_CORD_1_CAT_0='configs/noise_guide/sampling_guided_cord_1_cat_0.yml'
RESULT_PATH__CORD_1_CAT_0='experiments/noise_guide_v2/baseline_cord_1_cat_0'

CONFIG_FILE_CORD_1_CAT_0_1='configs/noise_guide/sampling_guided_cord_1_cat_0_1.yml'
RESULT_PATH__CORD_1_CAT_0_1='experiments/noise_guide_v2/baseline_cord_1_cat_0_1'

CONFIG_FILE_CORD_0_CAT_0='configs/noise_guide/sampling_guided_cord_0_cat_0.yml'
RESULT_PATH__CORD_0_CAT_0='experiments/noise_guide_v2/baseline_cord_0_cat_0'
